...
const selectTriggerStyles = [
  cx(
    ...
    "dark:data-disabled:border-slate-700 dark:data-disabled:bg-slate-800 dark:data-disabled:text-slate-500",
    focusInput
    // invalid (optional)
      ...
      <SelectPrimitives.Icon asChild>
        <RiExpandUpDownLine
          className={cx(
            ...
            // disabled
            "group-data-disabled/trigger:text-slate-300 dark:group-data-disabled/trigger:text-slate-600"
          )}
        />
