    ...
    <button
      ...
      className={cx(
        ...
        disabled
          ...
          : "cursor-pointer text-slate-700 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-50"
      )}
      disabled={disabled}
      onClick={(e) => {
        e.stopPropagation();
        ...
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cx(
                  "stroke-slate-200 stroke-1 dark:stroke-slate-800"
                )}
                horizontal={true}
                vertical={false}
              />
            ...
            >
              {xAxisLabel && (
                <Label
                  ...
                  offset={-20}
                  className="fill-slate-800 text-sm font-medium dark:fill-slate-200"
                >
                  {xAxisLabel}
                </Label>
              )}
              ...
              <Line
                ...
                activeDot={(props: any) => {
                  ...
                  return (
                    <Dot
                      className={cx(
                        "stroke-white dark:stroke-slate-950",
