      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            {title && (
              <ToastPrimitives.Title className="text-sm font-semibold text-slate-900 dark:text-slate-50">
                {title}
              </ToastPrimitives.Title>
            )}
            {description && (
              <ToastPrimitives.Description className="text-sm text-slate-600 dark:text-slate-400">
                {description}
